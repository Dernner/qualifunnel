...
ActiveRecord::Schema[7.1].define(version: 2026_05_30_160000) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.bigint "qualifunnel_flags", default: 1, null: false
  ...
  create_table "kanban_board_steps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "probability", precision: 5, scale: 2, default: "0.0"
    t.string "color"
    t.text "description"
    t.integer "tasks_count", default: 0, null: false
    t.index ["board_id", "position"], name: "index_kanban_board_steps_on_board_id_and_position"
  ...
  create_table "kanban_tasks", force: :cascade do |t|
    ...
    t.index ["board_step_id", "position"], name: "index_kanban_tasks_on_board_step_id_and_position"
  ...
  add_foreign_key "conversations", "kanban_tasks", on_delete: :nullify
  ...
  add_foreign_key "kanban_products", "kanban_boards", column: "board_id"
  ...
  add_foreign_key "kanban_task_products", "kanban_tasks", column: "task_id"
